...
class MovingArm(VecTask):
    ...
    def compute_observations(self):
        ...
        self.goal_pos = self.root_state_tensor[self.fullbody_indices, 0:3].clone()
        self.goal_pos[:,0:1] += grasp_front_dist
    ...
    def compute_full_state(self, asymm_obs=False):
        ...
        self.obs_buf[:,hand_goal_start:hand_goal_start+3] = self.goal_pos
        hand_goal_start += 3
