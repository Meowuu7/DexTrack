...
class IKWrapper:
    def __init__(self):
        ...
        # self.model = mujoco.MjModel.from_xml_path(os.path.join(ROOT_PATH, "./assets/franka_emika_panda/scene_leap.xml"))
        #self.model = mujoco.MjModel.from_xml_path(os.path.join(ROOT_PATH, "./assets/franka_emika_panda/scene_allegro.xml"))
    ...
    def inverse_kinematics(self, model, data, target_mat, target_pos, reset_joint_positions):
        ...
        # data.qpos[:] = reset_joint_positions+ [0.00] * 2
        ...
        for steps in range(max_steps):
            ...
            print("err_norm",err_norm, ";err_rot", err_rot, ";err_pos", err_pos)
            if err_norm < 1e-10:
                break
    ...
    def interpolate_dense_traj(self, joint_seq, minimal_displacement=0.004):
        new_joint_seq = []
