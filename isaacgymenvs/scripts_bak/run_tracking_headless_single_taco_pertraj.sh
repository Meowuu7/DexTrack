...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_all' # !
export max_epochs=1000
...
# bash scripts/run_tracking_headless_single_taco_pertraj.sh
