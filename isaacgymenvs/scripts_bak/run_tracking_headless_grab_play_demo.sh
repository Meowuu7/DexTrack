...
export datanm_to_replay_fn_dict_fn='../assets/optimized_res_grab_300_demo/statistics/data_inst_tag_to_optimized_res_top50.npy'
export datanm_to_replay_fn_dict_fn='../assets/optimized_res_taco_400_demo/statistics/data_inst_tag_to_optimized_res_top50.npy'
export datanm_to_replay_fn_dict_fn='../assets/optimized_res_grab_300_demo/statistics/data_inst_tag_to_optimized_res_top50_cbd.npy'
...
export numEnvs=128
export minibatch_size=128


export task_type="AllegroHandTrackingPlayDemo"
export train_type="HumanoidPPO"
