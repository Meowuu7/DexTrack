...
export obj_type_to_pre_optimized_traj='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_wdiffusion_samples/statistics/data_inst_tag_to_optimized_res.npy'
export obj_type_to_pre_optimized_traj='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_wdiffusion_samples_ws30_wohist_datav2_kineobjposcanon_/statistics/data_inst_tag_to_optimized_res.npy'
