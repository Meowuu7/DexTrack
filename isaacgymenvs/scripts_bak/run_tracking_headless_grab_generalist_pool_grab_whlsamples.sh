...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv1_' 

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv2_' 

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv3_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_d_'
...
# bash scripts/run_tracking_headless_grab_generalist_pool_grab_whlsamples.sh
