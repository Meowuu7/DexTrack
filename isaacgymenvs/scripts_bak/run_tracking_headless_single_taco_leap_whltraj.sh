...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_leap_whltrain_' # !
export max_epochs=10000 



export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_leap_whltrain_10insts_' # !
export max_epochs=10000 
...
# reduce the number of the training data in leap-taco #
