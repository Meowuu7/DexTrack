...
# export obj_type_to_ckpt_fn='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_modelv2_realleap/statistics/obj_type_to_optimized_res.npy'
# export single_instance_state_based_train=False
...
export test_inst_tag="ori_grab_s1_cubesmall_offhand_1"
export obj_type_to_ckpt_fn='../assets/obj_type_to_optimized_res.npy'
export obj_type_to_pre_optimized_traj='../assets/data_inst_tag_to_optimized_res_beta_v2.npy'
export obj_type_to_base_trajs=''
export sampleds_with_object_code_fn=''
export grab_obj_type_to_opt_res_fn=""
export taco_obj_type_to_opt_res_fn="../assets/obj_type_to_optimized_res_beta.npy"
export grab_inst_tag_to_optimized_res_fn=""
export taco_inst_tag_to_optimized_res_fn='../assets/data_inst_tag_to_optimized_res.npy'


export use_deploy_generalist=True
...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_leap_taco_generalist_direct_samples_pertrj_v3_' 

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_leap_taco_generalist_direct_samples_pertrj_v4_' 

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_leap_taco_generalist_direct_samples_pertrj_v4_testall_' 
# many different situations ## improve the model other than ## improve the model other than ##



# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_leap_taco_generalist_direct_samples_pertrj_v4_modelv2_' 
