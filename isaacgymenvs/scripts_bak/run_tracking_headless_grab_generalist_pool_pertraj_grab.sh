...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wcustomidamping_samples_realv2_' 
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wcustomidamping_samples_realv3_' 
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wcustomidamping_samples_realv3_d_' 
...
# bash scripts/run_tracking_headless_grab_generalist_pool_pertraj_grab.sh
