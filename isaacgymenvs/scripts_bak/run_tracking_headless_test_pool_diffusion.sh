...
# export obj_type_to_pre_optimized_traj='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_wdiffusion_samples_ws30_wohist_datav2_kineobjposcanon_repot/statistics/obj_type_to_optimized_res.npy'
# 
