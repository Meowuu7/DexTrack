...
# log path #
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_300_geneeral_train_seletion_res0.1_' # !
export max_epochs=10000
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_300_geneeral_train_seletion_res0.5_' # !
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_300_geneeral_train_seletion_res0.6_' # !
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_300_geneeral_train_seletion_res0.8_' # !
...
# ./runs/tracking_ori ## tracking ##
# ./runs/tracking_ori_grab_s2_apple_lift_obs_pure_state_wref_wdelta ##
# ./runs # get the tracking ## get the tracking ##

## get the tracking and the whltrain ##


# bash scripts/run_tracking_headless_single_taco_whltrain.sh
