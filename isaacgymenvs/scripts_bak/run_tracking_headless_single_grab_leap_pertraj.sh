...
# export minibatch_size=5000
# export strict_maxx_nn_ts=185
# # /cephfs/xueyi/data/TACO_Tracking_PK_LEAP/data/passive_active_info_ori_grab_s2_phone_call_1_interped_taco_20231104_030_v2_interpfr_60_interpfr2_60_nntrans_40.npy
# export tracking_save_info_fn='/cephfs/xueyi/data/TACO_Tracking_PK_LEAP/data'
# export tracking_data_sv_root='/cephfs/xueyi/data/TACO_Tracking_PK_LEAP/data'
# export hand_type='leap'
# export tracking_info_st_tag='leap_passive_active_info_'
# export test_taco_tag='taco_20231024_'
# # export test_taco_tag='taco_20231104_'
# ##### tune all instances settings; no initialization; simple training; with customized damping; TACO-400 #####
...
# export log_path='./runs'
export log_path='./runs_init_fr_traj_translations'
export log_path='./runs_init_fr_traj_translations_filter'
# export log_path='./runs_leap_hand_traj'
# export log_path='./runs_taco_grab_trajs'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_generalist_training'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v5'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v5_wsmooth'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres100'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres200_trajlen400'
# # export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_generalist_training_v2'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres100_smooth0.001'
# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres100_trajlen400'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_samples_rewthres50'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_samples_rewthres100_selectedinst'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_samples_rewthres100_selectedinst_smooth0.001'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.0_sup0.0001'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.001'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres200_smooth0.001_testsstiffness'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.001_customdamping'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_customdamping'

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_customdamping'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_customdamping'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_customdamping_v2'


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_customdamping_v2'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_sup0.0005_customdamping_v2'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_sup0.0005_customdamping_wglb_v2'


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_sup0.0005_customdamping_wglb_alltraj_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_grab_samples_reopt_v6_rewthres50_smooth0.00_sup0.0005_customdamping_alltraj_v2'

# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_150_customdamping_leap'


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_customdamping_v2_evalsplit'
export max_epochs=1000


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_150_train_winit_samples'
export max_epochs=500

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wcustomidamping' # !
export max_epochs=1000



# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_150_train_leap_wcustomdamping'
# export max_epochs=10000

# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_train_leap_wcustomdamping'
# export max_epochs=10000


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping' # !
export max_epochs=1000
...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_leap' # !
export max_epochs=500


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_realleap' # !
export max_epochs=1000


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_realleap' # !
export max_epochs=1000
export subj_nm='s1'

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_realleap_wovel' # !
export max_epochs=1000
export subj_nm='s1'


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wovel' # !
export max_epochs=1000
export subj_nm='s1'



export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wvel_stiffv2_' # !
export max_epochs=1000
export subj_nm='s1'


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wvel_stiffv3_' # !

export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wvel_stiffv3_' # ! # 0.95


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wvel_stiffv4_' # ! # effort = 20; stiffness = 20


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_wstatebased_wcustomidamping_modelv2_realleap_wvel_stiffv5_' # ! # effort = 20; stiffness = 20
export max_epochs=1000
export subj_nm='s1'
