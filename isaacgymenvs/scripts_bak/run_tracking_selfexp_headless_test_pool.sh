...
export optimized_data_sv_root=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_OPTFR
...
# export obj_type_to_optimized_res_sv_fn="obj_type_to_optimized_res_s2.npy"
# export data_inst_tag_to_optimized_res_sv_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_eval/statistics/data_inst_tag_to_optimized_res.npy"


export optimized_data_sv_root=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_OPTFR_v2
