...
# et
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_modelv2_realleap' # !
export max_epochs=1000


export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_taco_400_train_wstatebased_wcustomidamping_modelv2_realleap_novel' # !
export max_epochs=1000
...
# bash scripts/run_tracking_headless_single_taco_leap_pertraj.sh
