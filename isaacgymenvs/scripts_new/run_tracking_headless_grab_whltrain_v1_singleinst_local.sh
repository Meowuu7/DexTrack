...
# export exp_tag_raw="controllermultipletrajmodificationsingleinstduckv7"
...
# export exp_tag_raw="controllermultipletrajmodificationsingleinstappleeatv7"
...
# export exp_tag_raw="controllermultipletrajmodificationsingleinstbananaeatv7"
# export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s4_phone_lift_v7/passive_active_info_ori_grab_s4_phone_lift_nf_300_sample_0.npy'
# export exp_tag_raw="controllermultipletrajmodificationsingleinstphoneliftv7"
...
# export exp_tag_raw="controllermultipletrajmodificationsingleinstwatchsetv7"
# # export multiple_kine_source_trajs_fn='/data/xueyi/data/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s1_banana_eat_1_v7/passive_active_info_ori_grab_s1_banana_eat_1_nf_300_sample_0.npy'
# # export exp_tag_raw="controllermultipletrajmodificationsingleinstbananaeatv7"
...
export subj_idx=1
export inst_tag_raw='apple_eat_1'
export inst_tag_raw='banana_eat_1'
export inst_tag_raw='watch_set_2'
export inst_tag_raw='flashlight_on_2'
export inst_tag_raw='flashlight_on_1'
export inst_tag_raw='hand_inspect_1'
export inst_tag_raw='cubesmall_inspect_1'

export subj_idx=3
export inst_tag_raw='apple_eat_1'
export inst_tag_raw='phone_call_1'
...
# export multiple_kine_source_trajs_fn=/data/xueyi/data/modified_kinematics_data/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s${subj_idx}_${inst_tag_raw}_v7/passive_active_info_ori_grab_s${subj_idx}_${inst_tag_raw}_nf_300_sample_0.npy
# export exp_tag_raw=trajmods${subj_idx}_${inst_tag_raw}_v7
export exp_tag_raw=trajmods${subj_idx}_${inst_tag_raw}_test
...
# export single_inst_tag='ori_grab_s4_phone_lift_nf_300'



export single_inst_tag=ori_grab_s${subj_idx}_${inst_tag_raw}_nf_300
...
# #### Version 1 orientation reward scheduling ####
# export lowest_ornt_rew_coef=0.03
# export highest_ornt_rew_coef=0.33
# #### Version 1 orientation reward scheduling ####
...
# export ornt_rew_coef_increasing_steps=100
# # export ornt_rew_coef_warm_starting_steps=50
# # export ornt_rew_coef_increasing_steps=100


# #### Version 2 orientation reward scheduling --- resuming from the checkpoint trained via version 1 reward scheduling ####
# export lowest_ornt_rew_coef=0.33
...
export mocap_sv_info_fn='./data/GRAB_Tracking_PK_reduced_300/data/passive_active_info_ori_grab_s2_apple_lift_nf_300.npy'
...
export target_inst_tag_list_fn="/root/diffsim/IsaacGymEnvs2/assets/inst_tag_list_s1.npy"
export target_inst_tag_list_fn=''
