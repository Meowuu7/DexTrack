...
export partial_obj_pos_info=False 
# glb_feat_per_skip, centralize_info
export history_window_size=60
export glb_feat_per_skip=1
export centralize_info=False
export use_clip_glb_features=False
...
# export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_kine_diff_AE_Diff_traj_forcasting_AEDiff_AE_Diff_task_cond_ws60_stedgoalcond_/model006750002.pt'
...
##### History and glb feature settings for the forcasting model #####
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_handobjinfo_/model000140001.pt'
export forcasting_model_weights='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_train_freq60_substep4_wforcasting_model_nhist_nbias_glbtraj_singletraj_s2_duck_train_forecast/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_01-17-30-28/last_forcasting_model_weight.pth'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_handobjinfo_wglbfeat_/model000050001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_handobjinfo_wglbfeat_/model000690001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeat_/model000180001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeatv2_woptresall_/model000360001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeatv2_woptresall_/model000770001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeatv2_/model000810001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeat_invfreq5v2_/model000340001.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_wglbfeat_wclipglbfeat_invfreq10ws10_/model001510001.pt'
# export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_traj_forcasting_ws60_centralize_partialobjposinfo_wglbfeat_wclipglbfeat_/model000660001.pt'
export forcasting_history_ws=10
export forcasting_inv_freq=60

export history_window_size=1
export glb_feat_per_skip=6
export centralize_info=True
export centralize_info=False
##### History and glb feature settings for the forcasting model #####
...
# export preset_cond_type=2 # cond type of 2 # 
...
export use_clip_glb_features=True


export forecasting_model_inv_freq=1
export forecasting_model_inv_freq=10
export forcasting_inv_freq=60


# export forecasting_model_inv_freq=5
# export preset_inv_cond_freq=5
...
##### Forcasting model conditioning setting #####
# export st_ed_state_cond=True
##### Forcasting model conditioning setting #####


##### Forcasting partial obj pos info #####
# export partial_obj_pos_info=True
# export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_kine_diff_AE_Diff_traj_forcasting_AEDiff_AE_Diff_ws60_v2_partialobjposinfo_/model000750002.pt'
##### Forcasting partial obj pos info #####
...
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_train_freq60_substep2_nresume_ninstfeat_v2_wohistory_nfuture_s2_/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_24-17-13-16/nn/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5.pth'
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_winstfeat_s2_randshiftcondv2_wforecast_/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_03-14-17-44/nn/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5.pth'
...
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_partialcentrotestv3_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_handobjcond_'
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeats_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeats_v2_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeatsv4_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeatsv4_woptresall_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeatsv4_wooptres_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_wclipglbfeatsv4_shiftcondfreq5_' 
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_handobjcond_wclipglbfeats_'
# export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_forcastv3_partialhandobjcond_textfeatures_' 
# how to make the forecasting work here? ## work~here ##
