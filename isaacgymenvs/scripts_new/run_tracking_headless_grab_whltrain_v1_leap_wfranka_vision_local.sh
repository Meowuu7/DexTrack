...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_${hand_type}_v2urdf_wcustomdamping_v3goal_woft${wo_fingertip_pos}_woftrotvel${wo_fingertip_rot_vel}_dofspeedvel${dofSpeedScale}_ctlfreqinv${controlFrequencyInv}_nkinebias${not_use_kine_bias}_trcoef${warm_trans_actions_mult_coef}_dr${randomize}v${dr_version}_rewv${rew_version}_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}_wovel${wo_vel_obs}
######### Randomization settings #########
...
export log_path=./logs/isaacgym_rl_exp_grab_300_train_${hand_type}_v2urdf_wcustomdamping_v3goal_woft${wo_fingertip_pos}_woftrotvel${wo_fingertip_rot_vel}_dofspeedvel${dofSpeedScale}_ctlfreqinv${controlFrequencyInv}_nkinebias${not_use_kine_bias}_trcoef${warm_trans_actions_mult_coef}_dr${randomize}v${dr_version}_rewv${rew_version}_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}_wovel${wo_vel_obs}

######## Use the vision obs ########
export use_vision_obs=True
######## Use the vision obs ########
...
# export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_duck_inspect_1_v7
# export tracking_save_info_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_duck_inspect_1_v7'
# export tracking_data_sv_root='/data/xueyi/data/modified_kinematics_data_leap_wfranka/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_duck_inspect_1_v7'
# # export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_${hand_type}_v2urdf_wcustomdamping_v3goal_dofspeedvel${dofSpeedScale}_ctlfreqinv${controlFrequencyInv}_nkinebias${not_use_kine_bias}_trcoef${warm_trans_actions_mult_coef}_rewv${rew_version}_reornt_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}_wovel${wo_vel_obs}


# ######## Comute orientation reward settings ########
# export w_obj_ornt=False
# export include_obj_rot_in_obs=False
...
# export w_obj_ornt=True
# export include_obj_rot_in_obs=True # rew coef #
# export schedule_ornt_rew_coef=True # rew coef #
# export rew_version=7
# ######### activate the reorientation setting #########

# export log_path=${log_path}_reornt
