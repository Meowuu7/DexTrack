...
# export pure_test_inst_tag="ori_grab_s1_watch_set_1"
...
# export pure_test_inst_tag="ori_grab_s3_hammer_use_2"
# export pure_test_inst_tag="ori_grab_s1_wineglass_drink_2"
# export pure_test_inst_tag="ori_grab_s1_wineglass_toast_1"
# export pure_test_inst_tag="ori_grab_s4_wineglass_drink_2"
# export pure_test_inst_tag="ori_grab_s1_lightbulb_pass_1"
# export pure_test_inst_tag="ori_grab_s1_banana_peel_1"
# export pure_test_inst_tag="ori_grab_s1_mouse_pass_1"
# export pure_test_inst_tag="ori_grab_s1_watch_set_2"
...
# export pure_test_inst_tag="ori_grab_s2_cubesmall_inspect_1"
# export pure_test_inst_tag="ori_grab_s4_flashlight_pass_1"
...
export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export tracking_save_info_fn=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export tracking_data_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export kine_ed_tag="_sample_0.npy"
# export kine_ed_tag="_sample_1.npy"
# export kine_ed_tag="_sample_2.npy"
...
######## use multiple trajectories for training the model ########
export use_multiple_kine_source_trajs=True
# export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_vrandsamplesv2/tot_tot_sampled_dict.npy'
# export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka_v7urdf_winterp/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npy'
export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npy'
export multi_traj_use_joint_order_in_sim=True
export kine_ed_tag="_sample_0.npy"
# export add_forece_obs=False
export add_forece_obs=True
export lowest_ornt_rew_coef=0.03
export highest_ornt_rew_coef=2.0
export ornt_rew_coef_warm_starting_steps=130
export ornt_rew_coef_increasing_steps=2000
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_${hand_type}_v2urdf_wcustomdamping_v3goal_ts${train_student_model}_woft${wo_fingertip_pos}_woftrotvel${wo_fingertip_rot_vel}_dofspeedvel${dofSpeedScale}_ctlfreqinv${controlFrequencyInv}_nkinebias${not_use_kine_bias}_dr${randomize}v${dr_version}_${test_inst_tag}
export log_path=${log_path}_reornt_hodist${schedule_hodist_rew_coef}_mt
######## use multiple trajectories for training the model ########
...
# TODO: 
# headless; and also should be careful about the hand type
...
export demonstration_tuning_model=True
export preload_experiences_tf=True
#### sample 6 ####
# export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_rewv7_franka_ori_grab_s2_hammer_use_2_nf_300_table0.5_reornt_hodistFalse_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_15-18-23-08'
# export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_rewv7_franka_ori_grab_s2_hammer_use_2_nf_300_table0.5_reornt_hodistFalse_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_15-18-23-08/experience_buffer_sv_0.npy'
export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_rewv7_franka_ori_grab_s2_hammer_use_2_nf_300_table0.5_reornt_hodistFalse_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_18-16-28-46'
#### sample 6 ####
#### sample 9 ####
# export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_rewv7_franka_ori_grab_s2_hammer_use_2_nf_300_table0.5_reornt_hodistFalse_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_15-21-18-45'
# export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_rewv7_franka_ori_grab_s2_hammer_use_2_nf_300_table0.5_reornt_hodistFalse_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_16-00-58-05'
#### sample 9 ####
...
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_16-02-51-09/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_1000_rew_121.048004.pth'
export checkpoint=''


export load_experiences_maxx_ts=120

###### demonstration tuning model -- single instance demonstrations ######
export preload_all_saved_exp_buffers=False
export demonstration_tuning_model_freq=5 # 2
###### demonstration tuning model -- single instance demonstrations ######


# ###### demonstration tuning model -- single instance -- pure BC ######
# export learning_rate=0.001
# # export learning_rate=0.0005
# export demonstration_tuning_model_freq=1
# export numEnvs=10000
# export minibatch_size=10000
# ###### demonstration tuning model -- single instance -- pure BC ######

export load_chunking_experiences_from_real=False

export log_path=${log_path}_demotune



# ###### demonstration tuning model -- multiple instances -- BC with RL ######
# export st_idx=0
# export demonstration_tuning_model_freq=5
export learning_rate=0.0005
# # export numEnvs=40000
# # export minibatch_size=40000
# export numEnvs=25000 # 30000
# export minibatch_size=25000 # 30000
# ###### demonstration tuning model -- multiple instances -- BC with RL ######


export save_experiences_via_ts=True

export traj_idx_to_experience_sv_folder=''

##### action chunking default settings #####
export load_chunking_experiences_v2=False
export action_chunking_skip_frames=1
export action_chunking_frames=10
export use_no_obj_pose=False
export action_chunking=False
export bc_style_training=False
##### action chunking default settings #####

export preset_multi_traj_index=-1


###### Eight trajectories, 8 x 10000 expereiences, pure BC ######
export traj_idx_to_experience_sv_folder='../assets/traj_idx_to_experience_sv_folder.npy'
export save_experiences_via_ts=True
export load_experiences_maxx_ts=500
export demonstration_tuning_model_freq=1 # pure BC #
export st_idx=0

# ### sampling ###
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_19-22-22-27/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_2000.pth'
# export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
# export tracking_save_info_fn=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
# export tracking_data_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v15urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
# export use_v2_leap_warm_urdf=True
...
###### Eight trajectories, 8 x 100 expereiences, pure BC ######
### dense hand and object target frames ###
# export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v2urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v8
# export tracking_save_info_fn=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v2urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v8
# export tracking_data_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v2urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v8
...
export use_no_obj_pose=False
export action_chunking_frames=10
export history_length=20
export action_chunking_skip_frames=10
export load_chunking_experiences_v2=True
# export preload_experiences_path='../assets/traj_idx_to_demo_dict.npy'
export preload_experiences_path='../assets/traj_idx_to_demo_dict_1.npy'
export numEnvs=5000
export minibatch_size=5000
...
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_19-23-11-49/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_10000.pth'
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-11-25-31/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_11400.pth'
export history_chunking_obs_version='v2'
# export history_chunking_obs_version='v1'


export load_chunking_experiences_from_real=True
export preload_experiences_path='./selected_res_hammer_reorient_sample_9'
...
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-11-25-31/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_30000.pth'
export max_epochs=50000
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-16-45-02/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_11200.pth'

export horizon_length=32

export numEnvs=300
export minibatch_size=300


export horizon_length=256

export numEnvs=30
export minibatch_size=30
...
##### Sampling ######
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-16-45-02/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_11200.pth' # sim network arch v2 
export load_chunking_experiences_from_real=False
export history_freq=1
export preset_multi_traj_index=9
...
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-20-21-58/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_19200.pth'
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-20-21-58/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_50000.pth' # 
# export checkpoint='ckpts/hammer_real_tuned_chunked_model_v5.pth' # # 
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-17-20-14/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_30000.pth' #
export checkpoint='ckpts/hammer_real_tuned_chunked_model_v6.pth' # v6 #
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_21-17-12-39/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_400.pth' # 
# export checkpoint='ckpts/hammer_real_tuned_chunked_model_transformer_v1.pth' 
export checkpoint='ckpts/hammer_real_tuned_chunked_model_v10.pth' 
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_21-17-12-39/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_2200.pth'
export checkpoint='ckpts/hammer_real_tuned_chunked_model_v11.pth'
export load_chunking_experiences_from_real=True 
export toreal=1 
export headless=True 
...
export log_path=./isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_franka 
# ##### Sampling ######
