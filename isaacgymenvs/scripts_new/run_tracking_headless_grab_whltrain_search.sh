...
export obj_type_to_base_trajs_config=''
...
# export teacher_model_inst_tags_fn='/root/diffsim/IsaacGymEnvs2/assets/inst_tag_list_s10.npy'
# export supervised_loss_coef=0.0000
# export supervised_loss_coef=0.0005
...
###### Searching setting ######
export launch_type='trajectory_baseline_search'
export supervised_loss_coef=0.0000
export obj_type_to_base_trajs_config='../assets/inst_tag_to_fa_opt_res_top10_s10.npy'
export generalist_tune_all_instnaces=True
...
#### search for the optimization path ####
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_s10_selfexp_search'
export max_epochs=1000
#### search for the optimization path ####


# export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_s10'
# export max_epochs=10000
