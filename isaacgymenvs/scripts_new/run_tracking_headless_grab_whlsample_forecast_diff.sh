...
export hist_cond_partial_obj_pos_info=False
export hist_cond_partial_obj_info=False
export hist_cond_partial_hand_info=False
...
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_kine_diff_AE_Diff_traj_forcasting_AEDiff_AE_Diff_task_cond_ws60_centralize_partialhandinfo_/model000980003.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_kine_diff_AE_Diff_traj_forcasting_AEDiff_AE_Diff_task_cond_ws60_centralize_partialhandinfo_/model001650003.pt'
export forcasting_model_weights='/cephfs/xueyi/uni_manip/tds_diffusion_exp/allegro_tracking_kine_diff_AE_Diff_traj_forcasting_AEDiff_AE_Diff_task_cond_ws60_centralize_partialhandinfo_v2_/model001100003.pt'
export partial_hand_info=True
...
##### Histroy conditional partial obj pos & obj & hand pose info settings #####
export hist_cond_partial_obj_pos_info=False
export hist_cond_partial_obj_info=False
export hist_cond_partial_hand_info=True
##### Histroy conditional partial obj pos & obj & hand pose info settings #####
...
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_partialcentrotestv3_diff_ndiffbastraj_' 
# export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_partialcentrotestv3_diff_nforcast_' 
