...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}

##### v1 version can work for duck but cannot grasp objects... #####
...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}_v2rew


### version 3 reward ###
# increase the hand palm position guidance and the thumb finger position guidance #
# increase position guidance for other fingers #
# increase guidance for joint angles #
export rew_finger_obj_dist_coef=0.2
export rew_delta_hand_pose_coef=0.5
export hand_pose_guidance_glb_trans_coef=1.0
export hand_pose_guidance_glb_rot_coef=10.0
export hand_pose_guidance_fingerpose_coef=0.5
export hand_qpos_rew_coef=0.05
...
### version 4 reward ###
# increase finger-obj dist coef; 
# decrease hand qpose guidance;
export rew_finger_obj_dist_coef=0.5
export rew_delta_hand_pose_coef=0.5
export hand_pose_guidance_glb_trans_coef=1.0
export hand_pose_guidance_glb_rot_coef=10.0
...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_franka_${test_inst_tag}_armmult${franka_delta_delta_mult_coef}_table${table_z_dim}_t${warm_trans_actions_mult_coef}r${warm_rot_actions_mult_coef}_v${rew_version}rew_
