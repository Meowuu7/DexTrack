...
# wish to run them for the duck instance #
export target_obj_type='duck'
export distinguish_kine_with_base_traj=True
export generalist_tune_all_instnaces=True
export maxx_inst_nn=1
export max_epochs=1000

export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_objtype_${target_obj_type}_w_basetraj_v3goal


# export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_objtype_${target_obj_type}_w_basetraj_v3goal
