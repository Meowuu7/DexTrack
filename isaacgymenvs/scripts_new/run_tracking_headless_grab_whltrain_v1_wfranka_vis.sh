...
# export vis_train_commands='python train.py task=${task_type} train=${train_type} sim_device='cuda:0' rl_device='cuda:0'  capture_video=False force_render=True headless=False '
