...
# export kine_ed_tag="_sample_6.npy"
...
# ####### translational stage only #######
# export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v16urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
# export tracking_save_info_fn=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v16urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
# export tracking_data_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v16urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
...
####### four stage #######
export kine_info_with_arm_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v17urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export tracking_save_info_fn=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v17urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export tracking_data_sv_root=/data/xueyi/data/modified_kinematics_data_leap_wfranka_v17urdf/GRAB_Tracking_PK_reduced_300_resampled_${pure_test_inst_tag}_v18
export kine_ed_tag="_sample_0.npy"
# export kine_ed_tag="_sample_1.npy"
...
# export kine_ed_tag="_sample_9.npy"
# export kine_ed_tag="_sample_10.npy"
export kine_ed_tag="_sample_31.npy"
export hand_glb_mult_scaling_progress_after=160
export hand_glb_mult_scaling_progress_before=310
export compute_hand_rew_buf_threshold=160
export use_actual_traj_length=True
####### four stage #######
...
# four stages #
export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka_v17urdf/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npy'
export multi_traj_use_joint_order_in_sim=True
export kine_ed_tag="_sample_0.npy"
# export add_forece_obs=False
export lowest_ornt_rew_coef=0.03
export highest_ornt_rew_coef=2.0
#### v1 ornt coef scheduling ####
# export ornt_rew_coef_warm_starting_steps=130
# export ornt_rew_coef_increasing_steps=2000
#### v1 ornt coef scheduling ####
#### v2 ornt coef scheduling ####
export ornt_rew_coef_warm_starting_steps=70
...
# # ######## use multiple trajectories for training the model, v16urdf, translational only ########
# export use_multiple_kine_source_trajs=True
# export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka_v16urdf/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npy'
# export multi_traj_use_joint_order_in_sim=True
# export kine_ed_tag="_sample_0.npy"
# export ornt_rew_coef_warm_starting_steps=130
# export ornt_rew_coef_increasing_steps=2000
# export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_${hand_type}_v2urdf_wcustomdamping_v3goal_ts${train_student_model}_woft${wo_fingertip_pos}_woftrotvel${wo_fingertip_rot_vel}_dofspeedvel${dofSpeedScale}_ctlfreqinv${controlFrequencyInv}_nkinebias${not_use_kine_bias}_dr${randomize}v${dr_version}_${test_inst_tag}
# export log_path=${log_path}_reornt_hodist${schedule_hodist_rew_coef}_mt
# # ######## use multiple trajectories for training the model, translational only ########
...
# export kine_ed_tag=f_sample_4.npy"
...
# #### multjiple ts modle training #### 
# export use_teacher_model=True
# export kine_ed_tag="_sample_0.npy"
# # export use_multiple_teacher=True
# # export optimizing_with_teacher_net=True
# export dagger_style_training=True
# export teacher_index_to_weights="../assets/teacher_idx_to_model_weights_ornt_trans.npy"
# # 
# export teacher_index_to_inst_tags='../assets/teacher_idx_to_inst_tags_v4.npy'
# export teacher_model_inst_tags_fn='../assets/inst_tag_list_s2.npy'
# export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_leap_wfranka_v17urdf/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npyAND/data/xueyi/data/modified_kinematics_data_leap_wfranka_v16urdf/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_hammer_use_2_v18/passive_active_info_ori_grab_s2_hammer_use_2_nf_300_merged_samples_v22.npy' # distill them into a single model #
# #### multjiple ts modle training #### 
...
#### sampling code #####
# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_18-20-25-12/nn/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5.pth' # mutipel, four stages, hammer use
# ######## hierarchical model test setting #########
# export switch_between_models=True
# export switch_to_trans_model_frame_after=310
# export switch_to_trans_model_ckpt_fn='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_17-01-39-29/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_800_rew_157.52585.pth'
# ######## hierarchical model test setting #########

## four stage multiple trajs ##
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-12-26-32/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_1200_rew_129.09213.pth'
export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_20-12-26-32/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_1400_rew_115.69154.pth'


# export checkpoint='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_leap_v2urdf_wcustomdamping_v3goal_tsFalse_woftFalse_woftrotvelFalse_dofspeedvel1_ctlfreqinv3_nkinebiasTrue_drFalsev34_ori_grab_s2_hammer_use_2_nf_300_reornt_hodistFalse_mt_wovelFalse_demotune/tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_21-01-43-04/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_leap_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_800_rew_136.40468.pth'
