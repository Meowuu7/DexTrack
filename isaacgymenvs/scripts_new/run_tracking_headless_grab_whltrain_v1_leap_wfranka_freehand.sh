...
export train_free_hand=False
export train_free_hand=True

# get v2 leap warm urdf #
# export use_v2_leap_warm_urdf=False
...
## freehand 
export log_path=${log_path}_wovel${wo_vel_obs}_fh
