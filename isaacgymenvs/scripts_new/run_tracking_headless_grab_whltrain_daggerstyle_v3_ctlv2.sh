...
export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_frteacherv5
export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_demotune

# teacher subj idx #
# export target_inst_tag_list_fn=/root/diffsim/IsaacGymEnvs2/assets/inst_tag_list_s${teacher_subj_idx}.npy
# export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_s${teacher_subj_idx}_v3goal_from_teacher
# teacher subj idx #
...
# # # Let them clone the teacher's behaviour # #
...
#### demonstration experiences training ####
export dagger_style_training=False
export demonstration_tuning_model=True
export demonstration_tuning_model_freq=10
export preload_experiences_tf=True
# export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_openlooptest_trajfromnn_/tracking_ori_grab_s9_duck_inspect_1_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.5_rot_0.5_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_27-20-20-37'
export preload_experiences_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_totsamples_tests2_openlooptest_trajfromnn_s9specialist_v2_sv_experiences'
#### demonstration experiences training ####
...
###### deactivate the demonsration_tuning_model setting ######
export demonstration_tuning_model=False
export demonstration_tuning_model_freq=10
export preload_experiences_tf=False
export preload_experiences_path=''
###### deactivate the demonsration_tuning_model setting ######
...
export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_ctlv2_fulltopartial
####### generalist training setting #######


## whether to add use prev targets or the calculated targets in the observations ##
export use_actual_prev_targets_in_obs=False


export multi_traj_use_joint_order_in_sim=False
####### use multiple trajectory settings ########
export ts_teacher_model_weights_fn='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_v3goal_v2/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_02-17-05-57/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_1200_rew_134.22462.pth'
export use_local_canonical_state=True
export maxx_inst_nn=1
...
# export distinguish_kine_with_base_traj=False
export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_ctlv2_fulltopartial_multtraj
####### use multiple trajectory settings ########
...
####### use multiple trajectory settings ########
export ts_teacher_model_weights_fn='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_v3goal_v2/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_04-12-02-19/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_1600_rew_65.829155.pth'
export use_local_canonical_state=False
export maxx_inst_nn=1
export pure_test_inst_tag="ori_grab_s2_duck_inspect_1"
export test_inst_tag=${pure_test_inst_tag}_nf_300
...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_ctlv2_fulltopartial_multtraj_all_


export ts_teacher_model_weights_fn='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_v3goal_v2/tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_08-20-26-09/nn/last_tracking_ori_grab_s2_apple_lift_nf_300_obs_pure_state_wref_wdelta_density_500.0_trans_0.6024_rot_0.6024_goalcond_False_kinebias_t0.5r0.5f20_rfd_0.3_rh_0.5_ep_3200_rew_-44.36442.pth'
export ts_teacher_model_obs_dim=729
export w_obj_ornt=True
export include_obj_rot_in_obs=True
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_teacherfrom_duck_ctlv2_fulltopartial_multtraj_all_wornt_
...
# export preset_cond_type=1
export preset_cond_type=0


# ### number of envs and preload experienece path ###
# export numEnvs=5000
# export minibatch_size=5000
# export preload_experiences_tf=True
# export preload_experiences_path='/root/diffsim/IsaacGymEnvs2/isaacgymenvs'
