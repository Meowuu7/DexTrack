...
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_winstfeat_s2_randshiftcondv2_wforecast_'
export max_epochs=100000


export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_winstfeat_s2_randshiftcondv2_wforecastv2_'
export max_epochs=100000
...
# track hand and the object other than using the hand trajectory as the base policy #


export st_idx=1


# task description -> offline trajectories as the baes trajectory # 
# with online tracking targets genereation #

# planner in the loop training #

# and you need to track them # # cond # 

# bash scripts_new/run_tracking_headless_grab_whltrain_v1_forecast.sh
