...
export log_path=/data/xueyi/uni_manip/isaacgym_rl_exp_taco_300_ctlv2_${test_inst_tag}

# 

# ###### multiple synthesized trajectory generalist training ######
# export maxx_inst_nn=1
# # export pure_test_inst_tag="ori_grab_s9_hammer_use_2"
# export pure_test_inst_tag="ori_grab_s2_duck_inspect_1"
# export test_inst_tag=${pure_test_inst_tag}_nf_300
# export use_multiple_kine_source_trajs=True
# # export multiple_kine_source_trajs_fn='/data/xueyi/data/modified_kinematics_data_vrandsamplesv2/GRAB_Tracking_PK_reduced_300_resampled_ori_grab_s2_duck_inspect_1_v11/passive_active_info_ori_grab_s2_duck_inspect_1_nf_300_merged_samples.npy'
# # export distinguish_kine_with_base_traj=True
