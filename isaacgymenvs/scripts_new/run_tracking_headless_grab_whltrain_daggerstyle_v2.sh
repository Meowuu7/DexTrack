...
export preload_all_saved_exp_buffers=True
export demonstration_tuning_model_freq=2
export demonstration_tuning_model_freq=1
export numEnvs=10000
export minibatch_size=10000
export log_path=/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_supv1_0.0_ctlinv_1_all_v3goal_demotune_allbuffer
# deactivatte #
