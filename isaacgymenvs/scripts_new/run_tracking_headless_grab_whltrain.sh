...
export max_epochs=100000
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_train_freq60_substep2_nresume_ninstfeat_v2_wohistory_nfuture_freq5_ws5_s3_'
export max_epochs=100000
...
export max_epochs=10000
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_train_freq60_substep4_wforcasting_model_nhist_nbias_glbtraj_singletraj_s2_duck_train_forecast'
export max_epochs=10000
########## Forcasting model training ############
...
# distill and the masked distill #
