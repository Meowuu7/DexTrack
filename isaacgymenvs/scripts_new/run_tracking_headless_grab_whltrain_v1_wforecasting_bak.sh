...
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_wforecasting_hammeruse_trainforcaster_coef0_relmult_trajqposexpandobsfinger20fixobsv1_'
