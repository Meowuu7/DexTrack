...
export taco_inst_tag_to_optimized_res_fn=''
export obj_type_to_base_traj_fn='' # use; get the obj base traj # trackig #
...
# export object_type_to_latent_feature_fn="/root/diffsim/IsaacGymEnvs2/assets/obj_type_to_obj_feat.npy"
# export inst_tag_to_latent_feature_fn="/root/diffsim/IsaacGymEnvs2/assets/inst_tag_to_obj_feat.npy"
...
####### obj_type_to_ckpt_fn setting #########
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_nsup_downsample_moreinv_freq60_pertrain_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/root/diffsim/IsaacGymEnvs2/isaacgymenvs/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_nsup_downsample_moreinv_freq60_pertrain_fix_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_leap_fix_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_leap_fix_p3_d0.1/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_wfranka_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_wrandomize_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_wrandomize_onlymass_/statistics/obj_type_to_optimized_res.npy"
export obj_type_to_ckpt_fn="/data/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_freq60_pertrain_leap_fix_p100_d4_f0d95_remainsv3/statistics/obj_type_to_optimized_res.npy"
# export downsample=True
####### obj_type_to_ckpt_fn setting #########
...
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_sup0.0005_new_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_300_train_allegro_wcustomdamping_new_nsup_downsample_moreinv_freq60_persamples_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_leap_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_wfranka_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_wrandomize_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_wrandomize_onlymass_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_wrandomize_onlymass_v2_'
export log_path='/cephfs/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_300_persamples_wrandomize_onlymass_v3_'
export log_path='/data/xueyi/uni_manip/isaacgym_rl_exp_grab_realgrab_gensamplesv4_leap_damping_v2_test_'
# export max_epochs=1000
