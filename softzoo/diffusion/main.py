...
from dataset.get_data import get_dataset_loader
from model_util import create_model_and_diffusion
...
def main():
    ...
    # dist_util.steup_dist() # 
    # dist_util.setup_dist(args.device) # # dist util setup dist #


    print("creating data loader...")
    #### getthe dataset and the num frames ## ## get_dataset loader ##
    data = get_dataset_loader(name=args.dataset.dataset_type, batch_size=args.training.batch_size, num_frames=args.dataset.num_frames, args=args)
