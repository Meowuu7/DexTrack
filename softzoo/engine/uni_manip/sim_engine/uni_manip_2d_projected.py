...
class UniManip2D:
    def __init__(self, nn_particles, nn_links, nn_joints, nn_timesteps, dim, dt, obj_info_fn, link_joint_pos, link_joint_dir, link_parent_idx, exp_tag=None, cur_transformation_penalty_term=1000, cfg=None):
        ...
        self.rigid_body_inertia[None] = ti.Matrix([[1.0, 0.0], [0.0, 1.0]])
    ...
    # 
    def load_optimized_link_accs(self, opt_acc_rotations, opt_acc_translations):
        ## TODO: 
        self.link_rotational_accs.from_numpy(opt_acc_rotations)
        self.link_translational_accs.from_numpy(opt_acc_translations)
    ...
    def save_checkpoints(self, ii_iter, ckpt_sv_fn=None):
        ...
        save_info = {
            ...
            'link_rotational_vecs': self.link_rotational_vecs.to_numpy(), ## from the rotational vecs and translational vecs to rotational/translational vels and accs ##
        }
